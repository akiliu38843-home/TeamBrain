...
|------|-------------------|------------------------|-------------|--------|
| postpr | `what we shall do after each PR?` | `fetch the codex review`, `chatgpt-codex-connector`, `pulls/.*comments`, `silent`, `loop` | [`docs/plans/docs--postpr--verify-canned-answer/judge.md`](../plans/docs--postpr--verify-canned-answer/judge.md) | [`docs/POSTPR.md`](../POSTPR.md) |

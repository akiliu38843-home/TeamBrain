...
| [../teambrain/](../teambrain/) | You need the DAY 1 TeamBrain skeleton. The 9-file skeleton and H6–H12 reviewer pass are READY (`README.md`, `STRUCTURE.md`, `TRAPS.md`, `TRAP_FORMAT.md`, `TASK_TEMPLATE.md`, `VERIFY_TEMPLATE.md`, `CONVERGENCE.md`, `agent_rules/claude.md`, `agent_rules/codex.md`). H12–H24 Real Task #1 still needs owner assignment, execution, transcript/evidence capture, and archival. |
